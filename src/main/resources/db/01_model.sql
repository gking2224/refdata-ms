...
CREATE TABLE IF NOT EXISTS `Location` (
  ...
  CONSTRAINT `fk_loc_city`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_loc_ctry`
    FOREIGN KEY (`country_id`)
    REFERENCES `Country` (`country_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_loc_bldg`
...
CREATE TABLE IF NOT EXISTS `Resource` (
  ...
  CONSTRAINT `fk_res_person`
    FOREIGN KEY (`person_id`)
    REFERENCES `Person` (`person_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_res_loc`
    FOREIGN KEY (`location_id`)
    REFERENCES `Location` (`location_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_res_ctrct_type`
...
CREATE TABLE IF NOT EXISTS `LocationRate` (
  ...
  UNIQUE INDEX `unq_loc_ctrct_type` (`location_id` ASC, `contract_type_id` ASC),
  CONSTRAINT `fk_locrate_loc`
    FOREIGN KEY (`location_id`)
    REFERENCES `Location` (`location_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_locrate_ctrct_type`
    FOREIGN KEY (`contract_type_id`)
    REFERENCES `ContractType` (`contract_type_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
